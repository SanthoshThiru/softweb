    ...
    <div class="login">
        <form>
            ...
            <div class="image">
                ...
                <img src="/static/twitterx.jpg" width="35px">
            </div>
            
        </form>
    </div>
    <footer class="t">
        Designed and Developed by SanthoshT &copy;2023
    </footer>
...
<body>
    <header>
        ...
        <div class="cirpic">
            <img class="small border" src="/static/bg.png" width="500px">
            <img class="small border" src="/static/sj.png" width="500px" >
            <img class="small border" src="/static/sp.png" width="500px">
            <img class="small border" src="/static/em.png" width="500px">
            <img class="small border" src="/static/myself.jpg" width="500px">
    ...
    <header>
        ...
        <div class="search"><input type="text" placeholder="Enter to Search">
            ...
            <div class="contain">
                <table >
                    <tr>
                        <td><img src="/static/webdesign.jpg" height="200px" width="200px">
                            <p><b>WEBDESIGN&nbsp;</b><br>
                        ...
                        <td><img src="/static/python.png" height="200px" width="200px"><br>
                            <p><b>PYTHON <br>
                        ...
                        <td><img src="/static/cc+.png" height="200px" width="200px"><br>
                            <p><b>C/C++</b><br>
...
<head>
    ...
    <body>
        ...
        <div class="info">
            ...
            <b>Address: </b> Codenexa building ,near D'Wayer Resort,Erode, Tamil Nadu<br><br>
            ...
            <b>Phone: </b>044-2885 7859
                ...
                <footer class="u">
                    Designed and Developed by COPYRIGHTS @SANTHOSH T ;2023
                    </footer>
